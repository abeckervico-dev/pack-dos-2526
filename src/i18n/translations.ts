export const translations = {
  es: {
    ...
    experience: {
      ...
      schedule: {
        title: 'Horarios',
        morning: 'Turno Mañana: 9:00 AM',
        afternoon: 'Turno Tarde: 2:00 PM',
        season: 'Temporada: Octubre a Abril',
      }
    },
    safety: {
      ...
      equipment: {
        ...
        items: [
          'Packrafts certificados de alta calidad',
          'Chalecos salvavidas homologados',
          'Trajes secos para protección térmica',
          'Kit de primeros auxilios y rescate acuático',
          'Comunicación satelital de emergencia',
        ]
      },
      conditions: {
        title: 'Condiciones de Suspensión',
        description: 'La actividad se suspende por:',
        items: [
          'Vientos superiores a 22 nudos',
          'Condiciones hídricas desfavorables',
          'Alertas meteorológicas',
          'Decisión del guía por seguridad del grupo',
        ]
      }
    },
    gallery: {
    ...
    faq: {
      ...
      questions: [
        {
          q: '¿Necesito experiencia previa en kayak o packraft?',
          a: 'No es necesaria experiencia previa. Nuestros guías te brindarán una completa introducción sobre técnicas de remo y seguridad antes de comenzar la actividad.',
        },
        {
          q: '¿Qué debo llevar?',
          a: 'Ropa cómoda (preferentemente sintética), protector solar, gafas de sol, gorra, botella de agua y calzado que se pueda mojar. Nosotros proveemos todo el equipo técnico necesario.',
        },
        {
          q: '¿Es seguro para personas que no saben nadar bien?',
          a: 'Es requisito indispensable saber nadar. Todos los participantes usan chaleco salvavidas obligatorio durante toda la actividad.',
        },
        {
    ...
    contact: {
      ...
      info: {
        ...
        phone: '+54 9 2966 XX-XXXX',
        whatsapp: 'WhatsApp disponible',
        address: 'El Chaltén, Santa Cruz, Argentina',
      },
      booking: {
        title: 'Reserva directa',
        description: 'Reserva tu experiencia de forma segura a través de nuestra plataforma:',
        button: 'RESERVAR EN TURITOP',
      }
    },
    footer: {
      rights: 'Todos los derechos reservados',
      operator: 'Operado por Hiking Tour El Chaltén',
      certifications: 'Prestador habilitado PNLG | PAT 2.231 | CUIT: 20-34816054-1',
    }
  },
  en: {
    nav: {
    ...
    experience: {
      ...
      schedule: {
        title: 'Schedule',
        morning: 'Morning Shift: 9:00 AM',
        afternoon: 'Afternoon Shift: 2:00 PM',
        season: 'Season: October to April',
      }
    },
    safety: {
      ...
      equipment: {
        ...
        items: [
          'High-quality certified packrafts',
          'Approved life jackets',
          'Dry suits for thermal protection',
          'First aid and water rescue kit',
          'Emergency satellite communication',
        ]
      },
      conditions: {
        title: 'Cancellation Conditions',
        description: 'Activity is suspended due to:',
        items: [
          'Winds exceeding 22 knots',
          'Unfavorable water conditions',
          'Weather alerts',
          'Guide\'s decision for group safety',
        ]
      }
    },
    gallery: {
    ...
    faq: {
      ...
      questions: [
        {
          q: 'Do I need previous kayak or packraft experience?',
          a: 'No previous experience is necessary. Our guides will provide a complete introduction to paddling techniques and safety before starting the activity.',
        },
        {
          q: 'What should I bring?',
          a: 'Comfortable clothing (preferably synthetic), sunscreen, sunglasses, cap, water bottle, and footwear that can get wet. We provide all necessary technical equipment.',
        },
        {
          q: 'Is it safe for people who can\'t swim well?',
          a: 'Swimming is a mandatory requirement. All participants wear mandatory life jackets throughout the activity.',
        },
        {
    ...
    contact: {
      ...
      booking: {
        ...
        description: 'Book your experience safely through our platform:',
        button: 'BOOK ON TURITOP',
      }
    },
    footer: {
      rights: 'All rights reserved',
      operator: 'Operated by Hiking Tour El Chaltén',
      certifications: 'Licensed provider PNLG | PAT 2.231 | CUIT: 20-34816054-1',
    }
  }
}